...
export class ConstantURL {
    ...
    public static readonly ADD_ARTICLE_image = environment.GlobalApiUrl+"article/image/"
    public static readonly ADD_ARTICLE_comment = environment.GlobalApiUrl+"article/comment/"
    /*############################## URL Admin ################################*/
